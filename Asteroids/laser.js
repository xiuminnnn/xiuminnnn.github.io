...
function Laser(spos, svel, angle) {
  ...
  // Increase the radius of the laser
  this.r = 20; // Adjust this value to make the bullets larger

  this.render = function() {
    push();
    stroke(this.color[0], this.color[1], this.color[2]);
    strokeWeight(this.r); // Increase the strokeWeight to match the radius
